...
public class PruebasCombate {
    ...
    public PruebasCombate() {
        this.investigador= new Investigador();
        this.pilaVictoria=new LinkedList<Enemigo>();
    }
    ...
    public void enfrenta(){
        if(investigador.valorCombate>=enemigo.valorCombate){
            enemigo.salud=enemigo.salud-(1+investigador.modificadorDaño);
        }else{
            investigador.salud=investigador.salud-enemigo.daño;
        }
    }
